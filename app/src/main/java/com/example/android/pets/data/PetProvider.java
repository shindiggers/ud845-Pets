...
public class PetProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        mDbHelper = new PetDbHelper(getContext()); // Initialise DbHelper. Context to pass in depends on where this provider is called from so we use getContext()
        return true;
    }
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If ContentValues object has gender key,
        // check that the gender is valid
        ...
        // If ContentProvider object has weight key,
        // check if the weight is provided. If so check that it's greater than or equal to 0 kg
